...
# --- Configuration ---
DATA_PATH = "C:/Users/bhavn/Downloads/Physionet/bidmc19"  # Path to the physiological data record
...
if __name__ == "__main__":
    ...
    plt.plot(time, raw_ppg, color='#999999', alpha=0.4, label='Raw PPG (Noisy)')
    ...
    # --- Plot 2: Zoomed-in segment (5 cycles) ---

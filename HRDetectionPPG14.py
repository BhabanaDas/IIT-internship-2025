...
# --- Configuration ---
DATA_PATH = "C:/Users/bhavn/Downloads/Physionet/bidmc28"  # Path to the physiological data record
...
if __name__ == "__main__":
    ...
    plt.plot(time, raw_ppg, color="#F17878", alpha=0.4, label='Raw PPG (Noisy)')
